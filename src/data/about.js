export const introduction = `My name is Hayes, and I've been in the software industry for over 10 years. During that time, I have run and managed an enterprise-grade software development apprenticeship program. I've created curriculum, personally trained and mentored hundreds of people with little to no tech experience, and watched them succeed as developers at BIG companies.

I created Streamline South to focus my expertise on helping small businesses grow and automate their workflows and processes. Let's chat about the things you want to do with technology, but aren't sure how to get started. It seems like AI is everywhere these days, and if you want an industry expert to talk about how you can use it effectively, I can help!`
