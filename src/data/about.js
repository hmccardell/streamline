  ...
  rows: [
    {
      ...
      body: "I setup our training environment and expectations exactly how large organizations develop and deliver software: tools, processes, and all. N-tier and microservice architecture, REST APIs, authentication, test suites with mocking and integration coverage, Scrum events, hard to reach stakeholders that have the requirements, and more. By the time they leave training, they're already doing real development work in a realistic way.This photo is inside a jet engine at United Airlines' headquarters in Chicago's Willis Tower. We trained ten engineers for United through its Innovate apprenticeship program, and after six months on the job every one of them converted to a full-time role. Lately the bigger job has been moving that curriculum to AI-first development, the same shift I help Gulf Coast businesses make now.",
