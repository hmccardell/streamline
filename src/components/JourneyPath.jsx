      ...
      <div className="flex flex-col items-stretch gap-2 sm:flex-row sm:flex-wrap sm:items-center sm:justify-center sm:gap-0">
        {steps.map((step, i) => (
          <div key={step} className="flex items-center">
            <div className="surface-card card-accent flex w-full items-center gap-3 rounded-lg bg-surface px-4 py-3 sm:w-auto sm:flex-col sm:gap-1 sm:px-5 sm:py-4 sm:text-center">
